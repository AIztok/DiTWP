...
## Einlesen der Geometrie mittels DiTWP_Tools

Zuerst muss das Paket DiTWP_Tools installiert werden, siehe hierzu (vorher nicht vergessen zu speichern): [[012_Rhino_3D#DiTWP-Tools]]

Danach nutzen wir die Komponente zum Import von IFC:

![[112_UE_Import_IFC_2.png]]

Mit folgenden Input kann die Datei (diese soll entweder im gleichen Ordner wie die .gh Datei liegen oder vollen Pfad angeben) ins Grasshopper importiert werden:

![[112_UE_Import_IFC_1.png]]

Bodenplatte (IFC Datei) importiert (nur die Geometrie):

![[112_UE_Import_IFC_4.png]]

Diese kann danach zerlegt (`Deconstruct Brep`) werden und weiter bearbeitet:

![[112_UE_Import_IFC_3.png]]

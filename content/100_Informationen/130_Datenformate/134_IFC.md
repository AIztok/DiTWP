...
Derzeit wird das IFC Schema 5 entwickelt. Es wird mehrere Änderungen geben, unter anderen wird nicht mehr das EXPRESS verwendet sondern das JSON Datenformat, um dies auch leicht zu erkennen werden die IFC Dateien nach Schema IFC5 als `.ifcx` gespeichert.
Durch diese Änderung soll es wesentlich einfacher werden für Softwareentwickler das IFC Schema in ihre Software einzuarbeiten da ein JSON Schema (siehe auch [[132_JSON#JSON Schema]]) besser und einfacher zu verstehen ist.
...
## BonsaiBIM 
Siehe [[015_Blender & BonsaiBIM]]] und das Konzept von Native IFC [[111_VO#Native IFC]].

# Weiter Unterlagen

## Visualisierung IFC Datei

Kleine App zur Visualisierung der Struktur einer IFC Datei:
